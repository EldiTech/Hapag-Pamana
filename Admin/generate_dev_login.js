const { initializeApp, cert } = require("./Orders/backfill/node_modules/firebase-admin/app");
const { getAuth } = require("./Orders/backfill/node_modules/firebase-admin/auth");
const fs = require("fs");
const path = require("path");

initializeApp({ credential: cert(require(path.resolve("./Orders/backfill/serviceAccountKey.json"))) });
const auth = getAuth();
